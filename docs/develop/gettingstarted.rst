...
When compiling MicroPython, you compile a specific :ref:`port <glossary>`, usually
...
It can be opened in Visual Studio or build from the command line using msbuild. Alternatively, it can be build using mingw,
